...
$query = "SELECT id_nilai, nim, nilai FROM nilai WHERE id_nilai = '$id' AND jenis = 'quran'";
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Edit Nilai Quran</h5>
                    <div class="ibox-content">
                        <form action="aksi_edit_quran_msy.php" method="post">
                            ...
                            <a href="?page=quran_msy" class="btn btn-secondary">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
