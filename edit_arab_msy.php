...
$query = "SELECT id_nilai, nim, nilai FROM nilai WHERE id_nilai = '$id' AND jenis = 'arab'";
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Edit Nilai Arab</h5>
                    <div class="ibox-content">
                        <form action="aksi_edit_arab_msy.php" method="post">
