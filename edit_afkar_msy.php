...
$query = "SELECT id_nilai, nim, nilai FROM nilai WHERE id_nilai = '$id' AND jenis = 'afkar'";
        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Edit Nilai Afkar</h5>
                    <div class="ibox-content">
                        <form action="aksi_edit_afkar_msy.php" method="post">
