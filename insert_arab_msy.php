        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h2>Insert Nilai Arab</h2>
                </div>
                <div class="ibox-content">
                    <form action="aksi_insert_arab_msy.php" method="post">
                        ...
                        <input type="hidden" name="jenis" value="arab">
                        <button type="submit" class="btn btn-primary">Submit</button>
                        <a href="?page=arab_msy" class="btn btn-secondary">Cancel</a>
                    </form>
                    ...
                    // Ambil data nilai Afkar dari database
                                $query_arab = "SELECT n.id_nilai, n.nim, m.nm_mhs, n.jenis, n.nilai 
                                FROM nilai n 
                                JOIN mahasantri m ON n.nim = m.nim
                                WHERE n.jenis = 'arab'";
                                $result_arab = mysqli_query($koneksi, $query_arab);

                                if ($result_arab && mysqli_num_rows($result_arab) > 0) {
                                    while ($row = mysqli_fetch_assoc($result_arab)) {
                                        echo "<tr>";
                                        echo "<td>" . $row['nim'] . "</td>";
                                    ...
                                    echo "<tr><td colspan='4'>Tidak ada data nilai Arab</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
