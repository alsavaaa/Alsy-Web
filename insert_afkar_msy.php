        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h2>Insert Nilai Afkar</h2>
                </div>
                <div class="ibox-content">
                    <form action="aksi_insert_afkar_msy.php" method="post">
                        ...
                        <input type="hidden" name="jenis" value="afkar">
                        <button type="submit" class="btn btn-primary">Submit</button>
                        <a href="?page=afkar_msy" class="btn btn-secondary">Cancel</a>
                    </form>
                    ...
                    // Ambil data nilai Afkar dari database
                                $query_afkar = "SELECT n.id_nilai, n.nim, m.nm_mhs, n.jenis, n.nilai 
                                FROM nilai n 
                                JOIN mahasantri m ON n.nim = m.nim
                                WHERE n.jenis = 'afkar'";
                                $result_afkar = mysqli_query($koneksi, $query_afkar);

                                if ($result_afkar && mysqli_num_rows($result_afkar) > 0) {
                                    while ($row = mysqli_fetch_assoc($result_afkar)) {
                                        echo "<tr>";
                                        echo "<td>" . $row['nim'] . "</td>";
                                    ...
                                    echo "<tr><td colspan='4'>Tidak ada data nilai Afkar</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
